...
describe 'AVPixelFormats', ->

  describe 'AVPixelFormat', ->
  ...
  describe 'AVColorTransferCharacteristic', ->

    describe 'check predefined constants', ->

      it 'color transfer characteristic', ->
